...
class DeepConvNet(object):
  ...
  def loss(self, X, y=None):
    ...
    # Set train/test.py mode for batchnorm params since they
...
class BatchNorm(object):
  ...
  def forward(x, gamma, beta, bn_param):
    ...
    Note that the batch normalization paper suggests a different test.py-time
    ...
    - bn_param: Dictionary with the following keys:
      - mode: 'train' or 'test.py'; required
    ...
    if mode == 'train':
      ...
      #######################################################################
      # TODO: Implement the test.py-time forward pass for batch normalization. #
  ...
  def backward(dout, cache):
    ...
    # Referencing the original paper (https://arxiv.org/abs/1502.03167)       #
    # might prove to be helpful.                                              #
    # Don't forget to implement train and test.py mode separately.               #
    ###########################################################################
    # Replace "pass" statement with your code
