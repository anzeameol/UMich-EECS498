...
class Solver(object):
    ...
    - model.loss(X, y) must be a function that computes training-time loss and
      gradients, and test.py-time classification scores, with the following inputs
      and outputs:
      Inputs:
      ...
      label for X[i].
      Returns:
      If y is None, run a test.py-time forward pass and return:
    ...
    def check_accuracy(self, X, y, num_samples=None, batch_size=100):
        ...
        - num_samples: If not None, subsample the data and only test.py the model
